  ...
  ar: {
    ...
    contactPage: {
      ...
      contacts: [
        {
          name: "مهاجرين",
          phone: "+94772481814",
          displayPhone: "94772481814+",
          whatsapp: true,
        },
        {
          name: "إكرام",
          phone: "+94777681835",
          displayPhone: "94777681835+",
        },
      ],
      ...
      form: {
        ...
        invalidPhone: "يرجى إدخال رقم تواصل صحيح",
        ...
        monthOptions: [
          ...
          { value: "not-sure", label: "لم أحدد بعد" },
        ],
        countryCodeOptions: [
          ...
          { value: "+94", label: "+94 سريلانكا" },
          { value: "+20", label: "+20 مصر" },
          { value: "+962", label: "+962 الأردن" },
          { value: "+1", label: "+1 أمريكا/كندا" },
        ],
        tripOptions: [
